...
Q17. Five lines of code that will return a bar plot of the `midwest_prop` variable with a title `Plot of proportion by state`. X-axis is labeled as `state` and y-axis as `prop`. 
```{r}
#remove this comment and answer here
```
